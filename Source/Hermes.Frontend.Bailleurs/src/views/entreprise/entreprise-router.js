export class EntrepriseRouter {
  ...
  configureRouter(config, router) {
    config.map([
      ...
      { route: 'details-demande-sans-CERFA/:id?',  name: 'details-demande-sans-CERFA', moduleId: './details-demande-sans-CERFA', nav: true, title: 'Details demande sans CERFA', href: '#details-demande-sans-CERFA', breadcrumb: true  },
      { route: 'details-demande-avec-CERFA/:id?',  name: 'details-demande-avec-CERFA', moduleId: './details-demande-avec-CERFA', nav: true, title: 'Details demande avec CERFA', href: '#details-demande-avec-CERFA', breadcrumb: true },
