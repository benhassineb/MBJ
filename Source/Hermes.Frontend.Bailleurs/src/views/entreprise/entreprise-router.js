export class EntrepriseRouter {
  ...
  configureRouter(config, router) {
    config.map([
      ...
      { route: 'details-demande-avec-cerfa/:id?',  name: 'details-demande-avec-cerfa', moduleId: './details-demande-avec-cerfa', nav: true, title: 'Details demande avec cerfa', href: '#details-demande-sans-cerfa', breadcrumb: true },
